        ...
        "task": Resource(
            ...
            FieldSet(
                ...
                Field("status", Task.status, kind="enum", facet=True,
                      choices=("NEW", "ASSIGNED", "IN_PROGRESS", "BLOCKED", "DONE", "CANCELLED")),
                Field("priority", Task.priority, kind="enum", facet=True,
                      choices=("LOW", "NORMAL", "HIGH", "CRITICAL")),
                Field("kind", Task.kind, kind="enum", facet=True,
                      choices=("TASK", "MILESTONE", "APPROVAL", "FOLLOW_UP")),
        ...
        "ticket": Resource(
            ...
            FieldSet(
                ...
                Field("status", Ticket.status, kind="enum", facet=True,
                      choices=("OPEN", "PENDING", "IN_PROGRESS", "RESOLVED", "CLOSED")),
        ...
        "project": Resource(
            ...
            FieldSet(
                ...
                Field("status", Project.status, kind="enum", facet=True,
                      choices=("PLANNED", "ACTIVE", "ON_HOLD", "COMPLETED", "CANCELLED")),
        ...
        "device": Resource(
            ...
            FieldSet(
                ...
                Field("status", Device.status, kind="enum", facet=True,
                      choices=("ONLINE", "OFFLINE", "DEGRADED", "MAINTENANCE")),
